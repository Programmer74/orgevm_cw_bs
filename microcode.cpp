    ...
    switch (ADC[IR])          //декодирование команды
    {
        ...
        case 10:
         ...
         }
         {
                ...
                MicroCodMem("SelbusA=Sp,SelbusB=Ram,Selpc=Call,Unireg8=Cntsp,Unicod16=Wrpc ");
         }
         {
                // 4.3 микрокоманда
                Ram[Sp]=SP; RAMK=0;
         ...
         }
         {
                ...
                MicroCodMem("SelbusB=F,Mop=Add,Selpsw=Bitsw,Unibit=Wlocpsw,SelbusA=Asfr,Adsfr=Acc,Unibus8=Wram,Selpa=Acc,Selpb=Pb  ");
         }
         // 5.3 микрокоманда -сохранение PsW в SFR
         {
                Ram[Psw]=PSW;
                RAMK=0;
                MicroCodMem("SelbusB=Psw,SelbusA=Asfr,Adsfr=Psw,Unibus8=Wram,Unicontr=Ramk1 ");
         }
         goto finish;
         case 14:
         {
                //микропрограмма inc ad
                // 5.1 микрокоманда
                PB= Ram[(PSW&0x18)|(IR&0x3)];
                RAMK++;
                ss[0]=(IR&0x3)|0x30;
                ss[1]=0;
                //формирование и вывод мнемокода команды
                char stroka[10]="inc ad";
                Instr->Text=StrCat(stroka,ss);
                MicroCodMem("SelbusB=Ram,Unibus8=Ari,Uniralu=Wrpb ");
         }
         {
                // 5.2 микрокоманда - операция в АЛУ и формирование признаков результата
                Wrk = Ram[PB]; RAMK++; Ram[PB]= Wrk + 1; RAMK++;
         ...
         //3.2 - - операция в АЛУ и формирование признаков результата
         {
                ...
                char tt[5]="add  ";
                MicroCodMem("SelbusB=F,Mop=Add,Selpsw=Bitsw,Unibit=Wlocpsw,SelbusA=Asfr,Adsfr=Acc,Unibus8=Wram ");
         }
         //3.3
         {
                Ram[Psw]=PSW;
         ...
         case 11:
         {
                //микропрограмма xchd a,@ri
                // 11.1 -чтение операндов из АСС и памяти Code
                PB=CODE[PC++];
                RAMK++;
                MicroCodMem("SelbusB=Code,Uniralu=WrpbUnicod16=Incpc ");
                itoa(PB,&ss[0],16); //формирование мнемокода
                char stroka[10]="xchd a,@ri";
                Instr->Text=StrCat(stroka,ss);
         }
         ...
         case 6:
         {
                ...
                Wrk=CODE[PC++]; SP++; RAMK++;
                MicroCodMem("SelbusB=Code,Uniralu=Wrwrk,Unicod16=Incpc,Uniport=Cntsp,Uniport=Incsp ");
                itoa(Wrk,&ss[0],16);
         ...
         }
         {
                ...
                Ram[SP++]=PC;RAMK++;
                MicroCodMem("SelbusB=Pcl,SelbusA=Sp,Unibus8=WramNsfr,Uniport=Cntsp,Uniport=Incsp ");
         }
         ...
         }
         {
                ...
                Ram[Sp]=SP;  RAMK=0;
                MicroCodMem("SelbusB=Sp,SelbusA=Asfr,Adsfr=Sp,Unibus8=Wram,Unicontr=Ramk8 ");
         }
         goto finish ;
         case 9:
         {
                // микропрограмма lcall  met
         ...
         case 7:
         {
                //микропрограмма anl c,bit
                // 7.1- чтение адреса бита из второго байта команды
                Wrk=CODE[PC++];
                RAMK++;
                MicroCodMem("SelbusB=Code,Uniralu=Wrwrk,Unicod16=Incpc ");
                ss[0]=(Wrk&0x7)+0x30;
                ss[1]=0; //формирование мнемокода
         ...
         Ram[Psw]=PSW;
         RAMK=0;
         MicroCodMem("SelbusB=Psw,SelbusA=Asfr,Adsfr=Psw,Unibus8=WramNsfr,Unicontr=Ramk1 ");
         goto finish;
         case 8:
         {
                 //reti
         ...
         // 8.3 микрокоманда
         {
                ...
                RAMK=0;
                intra2=0;
                MicroCodMem("SelbusB=Sp,Adsfr=Sp,Unibus8=WramNsfr,Unicontr=Ramk1,Unicontr=Clrinta ");
                Instr->Text="reti";
