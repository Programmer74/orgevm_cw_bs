...
void __fastcall TForm1::GoToInt(
    void) //схема входа в прерывание \
                                                  //+ 0-микрококоманда
{
...
void __fastcall TForm1::Button1Click(TObject *Sender) { //функция клавиши  Сброс
  ...
  // if(CheckBox8->State==cbUnchecked)
  {
    ...
    // CODE[0x00]=0; //Nop для контроля прерываний
    // CODE[0x01]=0x02; CODE[0x02]=0; CODE[0x03]=0x11; //ljmp 23
    // CODE[0x11]=0x09;    // inc r1 (0000 1001)
    // CODE[0x12]=0x05; CODE[0x13]=0x01;    // inc ad
    // CODE[0x14]=0xa3;   // inc dptr
    // CODE[0x15]=0xf4;   // cpl a
    // CODE[0x16]=0xb7;   // xchd a, @r1 (1101 0111)
    // CODE[0x17]=0x12; CODE[0x18]=0x00; CODE[0x19]=0x25; //lcall 0x25
    // CODE[0x25]=0x32; //reti  0
    // CODE[0x1a]=0;    //конец теста
...
void __fastcall TForm1::Button3Click(
    TObject *Sender) { //запрос прерывания по H/L фронтуINT1 при IT1=1
  IE1 = 1;
  TCON = TCON | 0x8;
  Ram[Tcon] = TCON;
  CheckBox6->State = cbChecked;
...
void __fastcall TForm1::CheckBox2Click(
    TObject *Sender) { //внешняя установка маски INT1
...
void __fastcall TForm1::CheckBox3Click(
    TObject *Sender) { //внешняя установка маски INT0
...
void __fastcall TForm1::CheckBox4Click(
    TObject *Sender) { //внешнее разрешение прерываний
